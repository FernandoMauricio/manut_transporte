...
use app\models\ManutencaoAdminEncerradas;

/**
 * ManutencaoAdminEncerradasSearch represents the model behind the search form about `app\models\ManutencaoAdminEncerradas`.
 */
class ManutencaoAdminEncerradasSearch extends ManutencaoAdminEncerradas
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = ManutencaoAdminEncerradas::find()
        ...
        $query->andFilterWhere([
            ...
            'situacao_id' => 3, //SOLICITAÇÕES DE MANUTENÇÃO ENCERRADAS
        ]);
