...
class Transporte extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['data_solicitacao', 'data_prevista', 'hora_prevista', 'data_confirmacao', 'hora_confirmacao', 'tipo_transporte', 'usuario_solic_nome'], 'safe'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'usuario_solic_suport'=>'Usuário Suporte',
